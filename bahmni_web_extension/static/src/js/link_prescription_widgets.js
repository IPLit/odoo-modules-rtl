...
var link_prescription = FieldChar.extend({
   ...
   start: function() {
        ...
        this.parent.$el.find('.oe_web_example').replaceWith('<button name="latest-prescription" type="object" class="btn btn-sm" id="latest-prescription" accesskey="P">أحدث وصفة طبية</button>');
